    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.value == 1) {
                ...
                $(".wishlist-tooltip").find(".permission").hide();
                $(".wishlist-tooltip").find(".approved-collection").hide();
                $(".wishlist-tooltip").find(".unselected-collection").hide();
                ...
                $(".wishlist-tooltip").find(".permission").show();
                $(".wishlist-tooltip").find(".add").hide();
                $(".wishlist-tooltip").find(".remove").hide();
                $(".wishlist-tooltip").find(".approved-collection").hide();
                $(".wishlist-tooltip").find(".unselected-collection").hide();
                ...
                $(".wishlist-tooltip").find(".permission").hide();
                $(".wishlist-tooltip").find(".add").hide();
                $(".wishlist-tooltip").find(".approved-collection").show();
                $(".wishlist-tooltip").find(".remove").hide();
                $(".wishlist-tooltip").find(".unselected-collection").hide();
                $(".wishlist-tooltip").show();
                const timer = setTimeout(() => {
                ...
                $(".wishlist-tooltip").find(".approved-collection").hide();
                $(".wishlist-tooltip").find(".remove").hide();
                $(".wishlist-tooltip").find(".unselected-collection").show();
                $(".wishlist-tooltip").show();
                const timer = setTimeout(() => {
                    $(".wishlist-tooltip").hide();
                }, 2000);
