...
use App\Services\Web\FrontendBlogService;
...
class BlogController extends Controller
{
    ...
    public function getListView(Request $request): View
    {
        ...
        return view('admin-views.blog.index', compact('blogs', 'categories', 'searchValue', 'titleData', 'subTitleData', 'languages', 'defaultLanguage', 'blogId'));
    }
    ...
    public function getUpdateView(Request $request): View
    {
        ...
        $categories = $this->blogCategory->withoutGlobalScopes()
            ...
            ->orderBy('updated_at', 'desc')
            ->paginate(getWebConfig(name: 'pagination_limit'));
        return view('admin-views.blog.edit', compact('categories', 'blog', 'languages', 'defaultLanguage'));
    }
...
//        ]);
    ...
    {
        // This method would typically integrate with an AI service
    ...
    public function descriptionAutoFill(Request $request): JsonResponse
    {
        // This method would typically integrate with an AI service
        // For now, return a placeholder response
        return response()->json([
            'description' => 'AI Generated Description Based on Title and Content'
        ]);
    }

    public function seoSectionAutoFill(Request $request): JsonResponse
    {
        // This method would typically integrate with an AI service
        // For now, return a placeholder response
        return response()->json([
            ...
            'meta_keywords' => 'AI,Generated,Meta,Keywords'
        ]);
    }
