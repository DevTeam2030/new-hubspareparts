...
class BusinessSettingsController extends BaseController
{
    ...
    public function getView(): View
    {
        ...
        $businessSetting = [
            ...
            'seller_points_setting' => $this->getSettings(object: $web, type: 'seller_points_setting')->value ?? '',
            'service_fee' => $this->getSettings(object: $web, type: 'service_fee')->value ?? '',
    ...
    public function updateSettings(BusinessSettingRequest $request, BusinessSettingService $businessSettingService): RedirectResponse
    {
        ...
        $this->businessSettingRepo->updateOrInsert(
            type: 'seller_points_setting',
            value: $request['seller_points_setting']
        );
        $this->businessSettingRepo->updateOrInsert(
            type: 'service_fee',
