...
class RegisterController extends BaseController
{
    ...
    public function getView():View|RedirectResponse
    {
        ...
        $helpTopics = $this->helpTopicRepo->getListWhere(
            ...
            dataLimit: 'all');
        return view(VIEW_FILE_NAMES[Auth::VENDOR_REGISTRATION[VIEW]],compact('vendorRegistrationHeader','vendorRegistrationReasons','sellWithUs','downloadVendorApp','helpTopics','businessProcess','businessProcessStep','governorates'));
    }
