...
class DeliveryManController extends Controller
{
    ...
    public function update_order_status(Request $request)
    {
       ...
       //add loyalty point for customer
        $loyaltyPointStatus = (int) getWebConfig('loyalty_point_status');
        if (
            ...
            $this->loyaltyPointTransactionRepo
                ->addLoyaltyPointTransaction(
...
// ————————————
    ...
    public function get_order_details(Request $request): JsonResponse
    {
        ...
        foreach ($details as $detail) {
            ...
            $detail['shipping_cost_order'] = $order->shipping_cost;
            $detail['service_fee_order'] = $order->service_fee;
            $detail['delivery_date'] = $order->delivery_date;
            $detail['selected_delivery_time'] = $order->selected_delivery_time;
        }
