        ...
        foreach ($nonEmptyRows as $index => $row) {
            try {
                ...
                $data = [
                    ...
                    'colors' => $isUpdate ? $existingProduct->colors : json_encode([]),
                    'attributes' => $isUpdate ? $existingProduct->attributes : json_encode([]),
                    'choice_options' => $isUpdate ? $existingProduct->choice_options : json_encode([]),
                    'variation' => $isUpdate ? $existingProduct->variation : json_encode([]),
                    'images' => $isUpdate ? $existingProduct->images : json_encode([]),
                    'thumbnail' => $isUpdate ? $existingProduct->thumbnail : 'def.png',
                    'thumbnail_storage_type' => 'public',
                    'color_image' => $isUpdate ? $existingProduct->color_image : json_encode([]),
                    ...
                    'meta_image' => $isUpdate ? $existingProduct->meta_image : null,
                ...
                $seoData = [
                    ...
                    'max_image_preview' => 0,
                    'max_image_preview_value' => $isUpdate ? $existingProduct->seoInfo->max_image_preview_value : 0,
                    'image' => $isUpdate ? $existingProduct->seoInfo->image : null,
                    'updated_at' => now(),
                ];
