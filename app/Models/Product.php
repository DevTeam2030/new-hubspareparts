...
class Product extends Model
{
    ...
    {
        return $this->hasMany(Wishlist::class, 'product_id')->whereNotNull('wishlist_collection_id');
    }

    public function getWishListQuantitySumAttribute()
    {
        return $this->wishList()->sum('quantity');
    }
    ...
    public function getThumbnailFullUrlAttribute(): string|null|array
    {
        ...
        return $this->storageLink('product', $value, $this->thumbnail_storage_type ?? 'public');
    }
    ...
    public function getPreviewFileFullUrlAttribute(): string|null|array
    {
        ...
        return $this->storageLink('product', $value, $this->preview_file_storage_type ?? 'public');
    }
    ...
    public function getMetaImageFullUrlAttribute(): array
    {
        ...
        return $this->storageLink('product', $value, 'public');
    }
    ...
    public function getDigitalFileReadyFullUrlAttribute(): array
    {
        ...
        return $this->storageLink('product',$value,$this->digital_file_ready_storage_type ?? 'public');
    }
