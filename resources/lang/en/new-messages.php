...
return [
	...
	"Import completed with errors in :rows_count row(s)" => "Import completed with errors in :rows_count row(s)",
	"Import_completed_summary" => "Import completed: :success_count products imported successfully, :fail_count row(s) have errors",
	"No_products_were_imported" => "No products were imported",
