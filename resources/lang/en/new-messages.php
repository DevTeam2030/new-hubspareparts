...
return [
	...
	"if_enabled_this_category_will_be_available_on_the_website_and_customer_app" => "If enabled this category will be available on the website and customer app",
	"if_disabled_this_category_will_be_hidden_from_the_website_and_customer_app" => "If disabled this category will be hidden from the website and customer app",
	"_blogs_under_this_category" => " blogs under this category",
	"Are_you_sure_to_delete_this_category" => "Are you sure to delete this category",
	"blog_category_Add" => "Blog category Add",
	"blog_category_Setup" => "Blog category Setup",
	"blog_category_Name" => "Blog category Name",
	"Technology" => "Technology",
	"technology_category_image" => "Technology category image",
	"the_file_must_be_an_image" => "The file must be an image",
	"the_image_must_be_a_file_of_type_jpg_png_jpeg" => "The image must be a file of type jpg png jpeg",
	"the_image_may_not_be_greater_than_2_mb" => "The image may not be greater than 2 mb",
	"the_image_alt_text_must_be_a_string" => "The image alt text must be a string",
	"the_image_alt_text_may_not_be_greater_than_255_characters" => "The image alt text may not be greater than 255 characters",
	...
	"min read" => "Min read",
	"Help others discover this story" => "Help others discover this story",
	"Trending" => "Trending",
	"Trending Now" => "Trending Now",
	"Discover the most-read stories and insights from our community" => "Discover the most-read stories and insights from our community",
	"Articles" => "Articles",
	"Blog_not_found" => "Blog not found",
	"Our Journal" => "Our Journal",
	"Stories, insights, and ideas worth reading" => "Stories  insights  and ideas worth reading",
	"Recent" => "Recent",
