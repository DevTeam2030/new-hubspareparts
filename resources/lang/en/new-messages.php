...
return [
	...
	"Attribute_Variation" => "Attribute Variation",
	"Variation_Wise_Price" => "Variation Wise Price",
	"Delete_this_variation" => "Delete this variation",
	"This_will_remove_this_variation" => "This will remove this variation",
	"Deleted" => "Deleted",
	"Variation_has_been_removed" => "Variation has been removed",
	"Variation_Combinations" => "Variation Combinations",
	"Activate_All" => "Activate All",
	"Deactivate_All" => "Deactivate All",
	"Enable_or_disable_this_variation_for_sale" => "Enable or disable this variation for sale",
	"Enter_SKU" => "Enter SKU",
	"This_will_deactivate_all_variations" => "This will deactivate all variations",
	"Yes_Deactivate" => "Yes Deactivate",
	"Cannot_Delete" => "Cannot Delete",
	"At_least_one_variation_is_required" => "At least one variation is required",
	"You_want_to_delete_this_variation" => "You want to delete this variation",
	"Yes_Delete" => "Yes Delete",
	"All_variations_removed" => "All variations removed",
	"No_variations_to_clear" => "No variations to clear",
	"Clear_All_Variations" => "Clear All Variations",
	"This_will_remove_all" => "This will remove all",
	"Yes_Clear_All" => "Yes Clear All",
	"Cleared" => "Cleared",
	"All_variations_have_been_removed" => "All variations have been removed",
];
