...
return [
	...
	"download_the_excel_file_and_fill_it_with_proper_data" => "Download the excel file and fill it with proper data",
	"download_the_excel_file_and_fill_it_with_proper_data." => "Download the excel file and fill it with proper data.",
	...
	"once_you_have_downloaded_and_filled_the_excel_file" => "Once you have downloaded and filled the excel file",
	...
	"you_can_download_the_excel_file_to_understand_how_the_data_must_be_filled." => "You can download the excel file to understand how the data must be filled.",
	...
	"you_can_select_brand_and_categories_from_their_dropdowns_in_the_excel_file." => "You can select brand and categories from their dropdowns in the excel file.",
	...
	"location" => "Location",
	"delivery_center_name" => "Delivery Center Name",
	"governorate" => "Governorate",
	"enter_delivery_center_name" => "Enter Delivery Center Name",
	"price_per_km" => "Price per KM",
	"enter_price_per_km" => "Enter Price per KM",
	"max_distance_km" => "Max Distance (km)",
	"enter_max_distance" => "Enter Max Distance",
	"delivery_center_list" => "Delivery Center List",
	"search_by_delivery_center" => "Search by Delivery Center",
	"max_distance" => "Max Distance",
	"no_area_found" => "No area found",
	"governorate_setup" => "Governorate Setup",
	"governorate_name" => "Governorate Name",
	"enter_governorate_name" => "Enter Governorate Name",
	"min_shipping_cost" => "Minimum Shipping Cost",
	"enter_min_shipping_cost" => "Enter Minimum Shipping Cost",
	"governorate_list" => "Governorate List",
	"search_by_governorate_name" => "Search by Governorate Name",
	"no_governorate_found" => "No governorate found",
	"edit_governorate" => "Edit Governorate",
	"delivery_time_setup" => "Delivery Time Setup",
	"delivery_times_list" => "Delivery Times List",
	"no_delivery_times_found" => "No delivery times found",
	...
	"Seller Points Setting" => "Seller Points Setting",
	"Seller Points Conversion" => "Seller Points Conversion",
	"Enter sales amount for one point (e.g., 100)" => "Enter sales amount for one point (e.g.  100)",
	"Seller Points" => "Seller Points",
	...
	"100" => "100",
	"please_select_your_governorate" => "Please select your governorate",
	"The governorate id field is required." => "The governorate id field is required.",
	...
	"Enter service fee percentage for delivery" => "Enter service fee percentage for shipping",
	"Please choose a delivery time" => "Please choose a delivery time",
	...
	"batch" => "Batch",
	"total order" => "Total order",
	"Print Group Invoice" => "Print Group Invoice",
	"Seller points updated successfully." => "Seller points updated successfully.",
	"Cash on delivery" => "Cash on delivery",
	...
	"Mam" => "Mam",
	"send_OTP_or_Link" => "Send OTP or Link",
	"must_use_country_code_before_phone_number_if_using_phone" => "Must use country code before phone number if using phone",
	"enter_your_email_or_phone" => "Enter your email or phone",
	"Email or Phone" => "Email or Phone",
	"use_the_code_or_link_to_change_your_password_on_our_secure_website." => "Use the code or link to change your password on our secure website.",
	"we_will_send_you_a_temporary_OTP_or_reset_link" => "We will send you a temporary OTP or reset link",
	"use_your_registered_phone_or_email." => "Use your registered phone or email.",
	"Password_Reset" => "Password Reset",
	"If_you’re_having_trouble_clicking_the_button_copy_and_paste_the_URL_below_into_your_browser" => "If you’re having trouble clicking the button copy and paste the URL below into your browser",
	"This_link_will_expire_in_:minutes_minutes." => "This link will expire in :minutes minutes.",
	"If_you_did_not_request_this,_please_ignore_this_email" => "If you did not request this  please ignore this email",
	"Invalid_data" => "Invalid data",
	"يرجى اختيار وقت التوصيل" => "يرجى اختيار وقت التوصيل",
	...
	"Shade A3.5" => "Shade A3.5",
	"Shade A3" => "Shade A3",
	"Please_fill_all_required_shipping_fields" => "Please fill all required shipping fields",
	...
	"Please fill status fields" => "Please fill status fields",
	...
	"Selected governorate is invalid!" => "Selected governorate is invalid!",
	"if_enabled,_the_safe_payment_will_be_available_on_the_system." => "If enabled  the safe payment will be available on the system.",
	...
	"haitham" => "Haitham",
	"cib" => "Cib",
	"customer_has_not_sufficient_loyalty_point_to_take_refund_for_this_order" => "Customer has not sufficient loyalty point to take refund for this order",
	...
	"1000121517" => "1000121517",
	"cliant_name" => "Cliant name",
	...
	"><rjal78>" => "  rjal78 ",
	"ei6li6" => "Ei6li6",
	"nrz856%3Cxs1%2F&#x3c;xs2&#x2f;" => "Nrz856%3Cxs1%2F&#x3c xs2&#x2f ",
	"Roles and Permissions" => "Roles and Permissions",
	"Roles" => "Roles",
	"Know_about_our_company." => "Know about our company.",
	"Role updated." => "Role updated.",
	"Wishlist Collection" => "Wishlist Collection",
	"You_have_not_any_collection_yet" => "You have not any collection yet",
	"arabic_name" => "Arabic name",
	"due_date" => "Due date",
	"notes" => "Notes",
	"New collection Added." => "New collection Added.",
	"Minimum_order_quantity" => "Minimum order quantity",
	...
	"Manage wishlist collections" => "Manage wishlist collections",
	"Wishlist Collections" => "Wishlist Collections",
	"Manage Users" => "Manage Users",
	"You do not have permission to add to wishlist" => "You do not have permission to add to wishlist",
	"You do not have permission" => "You do not have permission",
	"you do not have permission to remove from cart" => "You do not have permission to remove from cart",
	"Product_not_found_in_cart" => "Product not found in cart",
	"can not add to approve collection" => "Can not add to approve collection",
	"can not add to approved collection" => "Can not add to approved collection",
	"Maximum_available_stock_reached" => "Maximum available stock reached",
	"Cannot update approved collection" => "Cannot update approved collection",
	"Quantity updated successfully" => "Quantity updated successfully",
	"Your_Message_Send_Successfully" => "Your Message Send Successfully",
	" governorate" => " governorate",
	"You do not have permission to update wishlist" => "You do not have permission to update wishlist",
	"You sould select collection" => "You sould select collection",
	"You should select collection" => "You should select collection",
	"Voltage" => "Voltage",
	"Current" => "Current",
	"Power" => "Power",
	"I/Ps" => "I/Ps",
	"NC_Contacts" => "NC Contacts",
	"NO_Contacts" => "NO Contacts",
	"No.Of_Poles" => "No.Of Poles",
	"Control_Voltage" => "Control Voltage",
	"do_not_have_the_excel_template" => "Do not have the excel template?",
	...
	"Code :code already exists for another product" => "Code :code already exists for another product",
	"Please upload an Excel file of type: xlsx" => "Please upload an Excel file of type: xlsx",
	"Field :field is required but missing or empty" => "Field :field is required but missing or empty",
	...
	"The file you uploaded does not contain any data rows" => "The file you uploaded does not contain any data rows",
	"The code format is invalid." => "The code format is invalid.",
	"Product SKU :code already exists for another product" => "Product SKU :code already exists for another product",
	"Product SKU: :code already exists for another product" => "Product SKU: :code already exists for another product",
	"The_file_size_must_not_exceed_10_MB" => "The file size must not exceed 10 MB",
	...
	"want_to_import_products" => "Want to import products",
	"The_file_you_uploaded_does_not_contain_any_data_rows" => "The file you uploaded does not contain any data rows",
	"Field_field_is_required_but_missing_or_empty" => "Field :field is required but missing or empty",
	"Category_name_not_found" => "Category :name not found",
	"Category_cat_not_found" => "Category \":cat\" not found",
	"cat_is_not_a_main_category_Please_select_a_main_category_from_the_dropdown" => "\":cat\" is not a main category. Please select a main category from the dropdown.",
	"Sub_category_sub_not_found_under_category_cat" => "Sub-category \":sub\" not found under category \":cat\"",
	"Child_category_child_not_found_under_sub_category_sub" => "Child category \":child\" not found under sub-category \":sub\"",
	"You_must_select_a_sub_category_before_selecting_a_child_category" => "You must select a sub-category before selecting a child category",
];
