                        ...
                        <button type="button" data-product-id="{{ $product['id'] }}"
                            ...
                            <div class="wishlist-tooltip" x-placement="top">
                                ...
                                <div class="inner">
                                    ...
                                    <span class="remove">it is added before</span>
                                    <span class="permission">{{translate('You do not have permission')}}</span>
                                    <span class="approved-collection">can not add to approved collection</span>
                                    <span class="unselected-collection">You should select collection</span>
                                </div>
                            </div>
                        </button>
...
{{--                            </button>--}}
                        ...
                        @endif
                            <select class="form-control" name="collection_id" id="collection_id" style="width: auto;">
                                <option value="" >Select  Collection</option>
                                @foreach( \App\Models\WishlistCollection::whereIn('user_id' , $relatedAccounts)->get() as $collection)
                                    <option value="{{$collection->id}}">{{$collection->name}}</option>
                                @endforeach

                            </select>
                            @if($product['product_type'] == 'digital' || ($product['product_type'] == 'physical' && $product->current_stock > 0) || ($product['product_type'] == 'physical' && $qty > 0))
                            <button type="button" data-product-id="{{$product['id']}}"
