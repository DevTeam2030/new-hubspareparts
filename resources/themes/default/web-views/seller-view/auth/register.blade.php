                                ...
                                <div class="col-lg-8">
                                    <div class="bg-white p-3 p-sm-4 rounded">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-4">
                                                    <label for="governorates" class="title-color d-flex gap-1 align-items-center">
                                                        {{ translate('governorate') }}
                                                    </label>
                                                    <select name="governorate_ids[]" id="governorates" class="form-control" required multiple>
