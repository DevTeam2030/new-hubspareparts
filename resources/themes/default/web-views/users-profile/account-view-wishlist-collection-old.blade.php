                    ...
                    <div class="card-body">
                        ...
                        <div class="card-inner">
                            <div class="form-row row g-4">
                                ...
                                <div class="row" id="reloadable-section">
                                    <div class="col-md-4">
                                        <h6>{{ __('Eng. Approve') }}</h6>
                                    ...
                                    <div class="table-responsive table-wrap">
                                        <table class="table-auto w-full border">
                                            ...
                                            <tr class="bg-gray-100">
                                                ...
                                                <th class="px-4 py-2">Export to Cart</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @if(getProductPriceByType(product: $product, type: 'discount', result: 'value') > 0)
                                                    ...
                                                    <td class="px-4 py-2">
                                                        ...
                                                        <span class="icon-close text-light">
                                                            <i class="las la-shopping-cart"> Add to cart</i>
                                                        </span>
                                                                </a>
                                                            @else
                                            ...
                                            @endforelse
                                            <tr>
                                                <td colspan="2"><h5>{{ __('Total Cost') }}</h5></td>
                                                <td colspan="6" id="wishlist-total-cost">{{number_format($totalPrice, 2)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="col-md-3" >
                                        <div class="btn-wrapper" id="export-section">
                                            @if($user->hasPermissionTo('web-export-to-cart'))
                                                {{--                                    <button id="export-all-wishlist" class="{{ ( $collection->eng_approve == null || $collection->eng_proc == null ) ? 'btn btn-buyNow btn-bg-2 disabled' : 'cmn_btn btn_bg_2'}} ">{{ __('Export all to cart') }}</button>--}}
                                                <button id="export-all-wishlist" class="cmn_btn btn_bg_2">{{ __('Export all to cart') }}</button>

                                            @else
                                                <button class="btn btn-buyNow btn-bg-2 disabled">{{ __('Export all to cart') }}</button>
                                            @endif
                                    ...
                                    <div class="col-md-4" id="export-section-selected">
                                        <div class="btn-wrapper">
                                            @if($user->hasPermissionTo('web-export-to-cart'))
                                                {{--                                <button id="export-selected-wishlist" class="{{ ( $collection->eng_approve == null || $collection->eng_proc == null ) ? 'btn btn-buyNow btn-bg-2 disabled': 'btn btn-buyNow btn-bg-2' }}">{{ __('Export selected to cart') }}</button>--}}
                                                <button id="export-selected-wishlist" class="btn btn-buyNow btn-bg-2">{{ __('Export selected to cart') }}</button>

                                            @else
                                                <button  class="btn btn-buyNow btn-bg-2 disabled">{{ __('Export selected to cart') }}</button>
