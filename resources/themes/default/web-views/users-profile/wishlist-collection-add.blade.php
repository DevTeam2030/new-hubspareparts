                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-inner">
                            <form class="mt-3 px-sm-2 pb-2" action="{{route('store-wishlist-collection')}}" method="post"
                                  id="profile_form"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <textarea  type="text" name="notes" class="form-control" placeholder="{{ __('Notes') }}">{{ old("notes") ?? "" }}</textarea>
                                    </div>
