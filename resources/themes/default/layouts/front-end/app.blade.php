...
<head>
    ...
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/custom_style.css') }}">
...
<script src="{{ theme_asset(path: 'public/assets/front-end/js/custom-servee-newwww.js') }}"></script>
