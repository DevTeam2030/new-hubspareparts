                    ...
                    @if(auth('customer')->check())
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}"
                                ...
                                @if(  \App\Models\User::find(auth('customer')->id())->hasRole('Account Owner') )
                                <a class="dropdown-item"
                                   href="{{route('account-roles')}}">  {{translate('Manage Roles')}} </a>
                                @endif
                                        <a class="dropdown-item"
                                           href="{{route('account-users')}}">
                                            @if(\App\Models\User::find(auth('customer')->id())->hasPermissionTo('web-addremove-members'))
                                    ...
                                    <a class="dropdown-item"
                                       href="{{route('account-wishlist-collections')}}">
                                        {{translate('Manage wishlist collections')}}
                                    </a>
                                <a class="dropdown-item"
