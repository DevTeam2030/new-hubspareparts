                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('order_management'))
                            <li class="nav-item {{Request::is('admin/orders*')?((Request::is('admin/forders/details/*') && request()->has('vendor-order-list')) ? '' : 'scroll-here'):''}}">
                        ...
                        @endif
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/location*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('location')}}">
                                <i class="tio-location nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('location')}}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{ Request::is('admin/location*') ? 'block' : 'none' }}">
                                <li class="nav-item {{ Request::is('admin/location/areas') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.location.areas.view') }}" title="{{translate('delivery_center')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('delivery_center')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/location/governorates') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.location.governorates.view') }}" title="{{translate('governorates')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('governorates')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/location/delivery-times') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.location.delivery-times.view') }}" title="{{translate('delivery_times')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('delivery_times')}}</span>
                                    </a>
                                </li>
                            </ul>
