            ...
            <div class="{{$template['order_information_status'] == 1 ? '' : 'd-none'}}" id="order-information">
                <table class="email-table">
                  ...
                  @if(isset($data['order']))
                    ...
                    @php($serviceFee        = $data['order']['service_fee'])
                    ...
                    @endif
                      @php($finalAmount = $total+$tax+$shipping+$serviceFee-$couponDiscount-$deliveryFeeDiscount)
                ...
                <dl class="email-dl">
                    ...
                    <dt class="flex-1">{{ translate('service_fee') }}</dt>
                    <dd class="flex-1 text-right">
                        {{isset($serviceFee) ? webCurrencyConverter(amount: $serviceFee) :setCurrencySymbol(amount: usdToDefaultCurrency(amount: 0), currencyCode: getCurrencyCode())}}
                    </dd>
