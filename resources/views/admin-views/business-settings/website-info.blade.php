                ...
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div class="form-group" style="width: 450px">
                            <label for="seller_points_setting">{{ translate('Seller Points Setting') }}</label>
                            <input
                                type="number"
                                name="seller_points_setting"
                                id="seller_points_setting"
                                class="form-control"
                                value="{{ $businessSetting['seller_points_setting'] ?? 0 }}"
                                placeholder="{{ translate('Enter sales amount for one point (e.g., 100)') }}"
                                min="0"
                            >
                        </div>

                        <div class="form-group" style="width: 450px">
                            <label for="seller_points_setting">{{ translate('Service Fee') }}</label>
                            <input
                                type="number"
                                name="service_fee"
                                id="service_fee"
                                class="form-control"
                                value="{{ $businessSetting['service_fee'] ?? 0 }}"
                                placeholder="{{ translate('Enter service fee percentage for delivery') }}"
                                min="0"
                            >
                        </div>
