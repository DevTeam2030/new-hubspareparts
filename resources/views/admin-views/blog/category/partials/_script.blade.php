<script>
    ...
    // Language tab switching for category forms
    $(document).on('click', '.form-dynamic-language-tab', function () {
        let lang = $(this).data('lang');
        let common = $(this).data('common');
        let targetSelector = $(this).data('target-selector');

        // Update active tab within the same card
        $(this).closest('.card-body').find('.form-dynamic-language-tab').removeClass('active');
        $(this).addClass('active');

        // Hide all sibling lang divs that share the same common group
        $(this).closest('.card-body').find('[data-common="' + common + '"], .category-lang-tab, .edit-category-lang').addClass('d-none');

        // Show target
        $(this).closest('.card-body').find(targetSelector).removeClass('d-none');
    });
