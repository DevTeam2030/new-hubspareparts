                    ...
                    <div class="row gy-3 flex-grow-1 w-100">
                        <div class="col-sm-6 col-xxl-3">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="key">{{ translate('governorates') }}</span>
                                    <span>:</span>
                                    <span class="value">
        @if($seller && $seller->shop)
                                            @foreach($seller->shop->governorates as $gov)
                                                {{ $gov->name }}@if(! $loop->last) - @endif
                                            @endforeach
                                        @else
                                            {{ translate('no_governorates') }}
                                        @endif
    </span>
                                </div>
                                <div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-body h-100">
                                        {{-- Inline form to update seller points --}}
                                        <form action="{{ route('admin.vendors.updatePoints', $seller->id) }}" method="POST" class="d-flex justify-content-between align-items-center">
                                            @csrf
                                            @method('PATCH')
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <input
                                                    ...
                                                    name="points"
                                                    value="{{ $sellerPoints }}"
                                                    class="form-control form-control-sm w-auto mb-1"
                                                    min="0"
                                                />
                                                <small class="text-capitalize">{{ translate('Seller Points') }}</small>
                                            </div>
