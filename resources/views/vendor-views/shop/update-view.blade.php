...
{{--                            <div class="col-md-6">--}}
{{--                                <div class="form-group">--}}
{{--                                    <label for="governorate" class="title-color text-capitalize">--}}
{{--                                        {{ translate('governorate') }} <span class="text-danger">*</span>--}}
{{--                                    </label>--}}
{{--                                    <select name="governorate_ids[]" id="governorate" class="form-control" required multiple>--}}
{{--                                        @foreach($governorates as $governorate)--}}
{{--                                            <option value="{{ $governorate->id }}"--}}
{{--                                                {{ in_array($governorate->id, old('governorate_ids', $shop->governorates->pluck('id')->toArray())) ? 'selected' : '' }}>--}}
{{--                                                {{ $governorate->name }}--}}
{{--                                            </option>--}}
{{--                                        @endforeach--}}
{{--                                    </select>--}}
