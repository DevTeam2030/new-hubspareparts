        ...
        <div class="row g-2">
            ...
            <div class="col-md-6">
                <div class="card card-body h-100 justify-content-center">
                    <div class="d-flex gap-2 justify-content-between align-items-center">
                        <div class="d-flex flex-column align-items-start">
                            <h3 class="mb-1 fz-24">{{ $dashboardData['sellerPoints'] ?? 0 }}</h3>
                            <div class="text-capitalize mb-0">{{translate('seller_points')}}</div>
                        </div>
                        <div>
                            <img width="40" src="{{dynamicAsset(path: 'public/assets/back-end/img/points.png')}}" alt="Points">
                        </div>
                    </div>
                </div>
            </div>
