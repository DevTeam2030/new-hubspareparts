...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'location', 'as' => 'location.'], function () {
        ...
        Route::controller(AreaController::class)->group(function () {
            Route::get('areas', 'index')->name('areas.view');
            ...
            Route::delete('areas/{id}', 'destroy')->name('areas.destroy');
        });
        // Governorate Routes
        Route::controller(GovernorateController::class)->group(function () {
            Route::get('governorates', 'index')->name('governorates.view');
            Route::post('governorates', 'store')->name('governorates.store');
            Route::get('governorates/{id}/edit', 'edit')->name('governorates.edit');
